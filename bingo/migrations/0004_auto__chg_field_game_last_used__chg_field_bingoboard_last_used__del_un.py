...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bingo_game', 'last_used', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'BingoBoard.last_used'
        db.alter_column(u'bingo_bingoboard', 'last_used', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Game.last_used'
        db.alter_column(u'bingo_game', 'last_used', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'BingoBoard.last_used'
        db.alter_column(u'bingo_bingoboard', 'last_used', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
